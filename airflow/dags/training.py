...
def _get_project_id():
  ...
  if key in extras:
    ...
    raise ('Must configure project_id in google_cloud_default connection from Airflow Console')
  return project_id
...
ARTICLE_CUSTOM_DIMENSION = '10'     # we can change these to try out diff combinations
...
schedule_interval = '00 21 * * *'       # we will run at the end of the day
...
# BigQuery training data query, this will fetch data from BQ
